...
if __name__ == "__main__":
    checkpoint_path = "/teamspace/studios/this_studio/ImgCap/trainning/checkpoints/checkpoint_epoch_40.pth"
    ...
    beam_width = 3
    generated_captions = beam_search_caption(model, image, vocab, decoder, beam_width=beam_width)
